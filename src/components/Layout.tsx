...
const Layout = ({ children, showNav = true }: LayoutProps) => {
  return (
    <div className="flex flex-col min-h-screen bg-nyaysetu-white max-w-md mx-auto">
      <main className="flex-1 pb-16">{children}</main>
      
      {showNav && (
        <nav className="fixed bottom-0 left-0 right-0 mx-auto max-w-md bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] rounded-t-xl">
